...
def index(request, *args, **kwargs):
    ...
    return render(request, 'donnees/index.html', context)
...
def rapport(request, *args, **kwargs):
    ...
    if request.method =="POST":
        ...
        if form.is_valid():
            ...
            print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
            return redirect("donnees:rapport")
        else:
            prin(">>>>>>>> error <<<<<<<<<<")
    
    return render(request, 'donnees/rapport.html', {'form':form}) 
...
def getRapport(request, *args, **kwargs):
    ...
    return render(request, 'donnees/rapport.html', {'rapports' : rapports})
...
def client(request, *args, **kwargs):
    ...
    if request.method =="POST":
        ...
        if form.is_valid():
           form.save()    
    return render(request, 'donnees/client.html', {'form':form})  
